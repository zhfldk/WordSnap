...
// 내부 데이터(발음 보관용) — 표엔 표시하지 않음
let pronunciations = new Map(); // word -> ipa string

// ===== 클라 측 리사이즈(413 방지 & 가독성↑) =====
...
btnAnalyze.addEventListener("click", async () => {
  ...
  try {
    ...
    const words = await extractWordsViaServer(small); // 최대 60개
